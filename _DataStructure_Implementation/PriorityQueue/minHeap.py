...
class MinHeap:
    def __init__(self, heapSize):
        # Create a complete binary tree using an array, Then use the binary tree to construct a PriorityQueue
        self.heapSize = heapSize

        # (heapSize + 1) ensures the list has enough space to accommodate the heap elements (typically indexed from 1)
        self.minheap = [0] * (heapSize + 1)  # This part creates a list filled with zeros.
